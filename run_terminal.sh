...
./mycompiler < examples/useless.tc
sleep ${sleep_time}
...
./mycompiler < my_examples/mine_1.tc
sleep ${sleep_time}
...
./mycompiler < my_examples/mine_2.tc
sleep ${sleep_time}
...
./mycompiler < my_examples/mine_3.tc
